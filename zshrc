...
# Focus Flow {
    ...
    alias flow1="ssh root@server1.focusflow.net -t 'screen -DRUS pyry.pennanen'"
    ...
    alias flowns1="ssh root@185.123.116.230 -t 'screen -DRUS pyry.pennanen'"
    alias flowns2="ssh root@7.86.252.138 -t 'screen -DRUS pyry.pennanen'"
